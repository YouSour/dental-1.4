...
// Method
import {activeRegisterReport} from '../../common/methods/outstanding_reports/active-register.js';

// Schema
import {ActiveRegisterSchema} from '../../common/collections/outstanding_reports/active-register.js';

// Page
import './active-register.html';

// Declare template
let indexTmpl = Template.Dental_activeRegisterReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            activeRegisterReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Dental_activeRegisterReport', hooksObject);
