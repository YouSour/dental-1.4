...
// Method
import {closedRegisterReport} from '../../common/methods/outstanding_reports/closed-register.js';

// Schema
import {ClosedRegisterSchema} from '../../common/collections/outstanding_reports/closed-register.js';

// Page
import './closed-register.html';

// Declare template
let indexTmpl = Template.Dental_closedRegisterReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            closedRegisterReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Dental_closedRegisterReport', hooksObject);
