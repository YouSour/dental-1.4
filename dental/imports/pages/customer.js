...
// Declare template
let indexTmpl = Template.Dental_customer,
    contactTmpl = Template.Dental_customerContact,
    formTmpl = Template.Dental_customerForm,
    showTmpl = Template.Dental_customerShow;
...
formTmpl.onCreated(function () {
    this.autorun(()=> {
        ...
        if (currentData) {
            this.subscribe('dental.customerById', currentData.customerId);
        }
    });
});
...
AutoForm.addHooks(['Dental_customerForm'], hooksObject);
