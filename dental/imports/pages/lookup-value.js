...
// Declare template
let indexTmpl = Template.Dental_lookupValue,
    optionsTmpl = Template.Dental_lookupValueOptions,
    formTmpl = Template.Dental_lookupValueForm;
...
formTmpl.onCreated(function () {
    this.autorun(()=> {
        ...
        if (currentData) {
            this.subscribe('dental.lookupValueById', currentData.lookupValueId);
        }
    });
});
...
AutoForm.addHooks(['Dental_lookupValueForm'], hooksObject);
