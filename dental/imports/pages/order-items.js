...
// Collection
import {OrderItemsSchema} from '../../common/collections/order-items.js';

// Page
import './order-items.html';

// Declare template
let indexTmpl = Template.Dental_orderItems,
    actionTmpl = Template.Dental_orderItemsAction,
    newTmpl = Template.Dental_orderItemsNew,
    editTmpl = Template.Dental_orderItemsEdit;
...
indexTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'dental.order.schema';
...
AutoForm.addHooks(['Dental_orderItemsEdit'], hooksObject);
