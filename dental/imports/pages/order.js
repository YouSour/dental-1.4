...
// Declare template
let indexTmpl = Template.Dental_order,
    actionTmpl = Template.Dental_orderAction,
    formTmpl = Template.Dental_orderForm,
    showTmpl = Template.Dental_orderShow;
...
indexTmpl.events({
    ...
    'click .js-invoice' (event, instance) {
        ...
        let path = FlowRouter.path("dental.invoiceReportGe", params, queryParams);
...
formTmpl.events({
    'blur [name="orderDate"]'(event, instance){
        console.log(event.currentTarget.value);
        Session.set('orderDate', '2016/09/17');
    },
});
...
AutoForm.addHooks(['Dental_orderForm'], hooksObject);
