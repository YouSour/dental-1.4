...
// Method
import {analysisPatientReport} from '../../common/methods/summary_reports/analysis-patient.js';

// Schema
import {AnalysisPatientSchema} from '../../common/collections/summary_reports/analysis-patient.js';

// Page
import './analysis-patient.html';

// Declare template
let indexTmpl = Template.Dental_analysisPatientReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            analysisPatientReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Dental_analysisPatientReport', hooksObject);
