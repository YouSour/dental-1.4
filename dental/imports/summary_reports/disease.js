...
// Method
import {diseaseReport} from '../../common/methods/summary_reports/disease.js';

// Schema
import {DiseaseSchema} from '../../common/collections/summary_reports/disease.js';

// Page
import './disease.html';

// Declare template
let indexTmpl = Template.Dental_diseaseReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            diseaseReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Dental_diseaseReport', hooksObject);
